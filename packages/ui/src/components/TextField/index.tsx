...
export const TextField = React.forwardRef<HTMLInputElement, TextFieldProps>(
  (
    ...
    const inputColor = objectsToString(inputVariant.colors.input[findMatch(valid.colors, color, 'blue')]);
    ...
    const labelColor = objectsToString(inputVariant.colors.label[findMatch(valid.colors, color, 'blue')]);
...
TextField.displayName = 'BlusteryUi. TextField';
