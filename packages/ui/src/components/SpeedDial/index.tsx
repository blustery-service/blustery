...
// types
import { open, handler, placement, offset, dismiss, animate } from '../../types/components/speedDial';
...
export function useSpeedDial() {
  const context: any = React.useContext(SpeedDialContext);
...
SpeedDial.displayName = 'BlusteryUi.SpeedDial';
