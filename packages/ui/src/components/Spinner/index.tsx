...
// types
import type { className, color } from '../../types/components/spinner';
...
export const Spinner = forwardRef<SVGSVGElement, SpinnerProps>(({ color, className, ...rest }, ref) => {
  // 1. init
...
Spinner.displayName = 'BlusteryUi.Spinner';
